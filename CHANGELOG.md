...
This release also lands a full code-review remediation pass (49 findings — H01–H19 and M01–M29, plus dependency/release findings D01–D02; H12 was adjudicated unachievable and reverted). Each finding was reproduced with a red-green regression, independently reviewed, and committed atomically. Entries below lead with the finding ID for traceability.
...
- **H12 (receipt currency → authoritative-gross binding) was adjudicated unachievable and reverted.** Binding a receipt's parsed currency to its authoritative gross total could not be done without regressing correct base-currency extraction paths; after extended investigation the change was reverted and is deliberately absent from this release.
