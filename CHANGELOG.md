...
- **`reconcile-bank` books interest credits to the correct financial-income account.** The unmatched-transaction guidance suggested account **6080 "Interest income"** for interest credits, but 6080 sits in the annual report's staff-costs range (6000–6999 "Tööjõukulud"); a revenue booking there falls outside the "Finantstulud ja -kulud" mapping (7200–7699 + 8000–8899), so `generate_annual_report_data` drops it into `unmapped_accounts` and silently excludes it from profit. It now books to **8400 "Intressitulu"** (financial income, 8xxx range), consistent with the Lightyear interest-income account, so bank interest lands on the annual report's financial-income line.
