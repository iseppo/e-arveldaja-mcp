...
MCP server for the Estonian e-arveldaja (RIK e-Financials) REST API. 129 tools, 15 workflow prompts, 13 resources. Works with any MCP client — Claude Code, Codex CLI, Gemini CLI, Cursor, Windsurf, Cline, and others.
