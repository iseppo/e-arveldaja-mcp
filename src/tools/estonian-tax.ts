      ...
      return {
        content: [{
          ...
          text: JSON.stringify({
            ...
            tsd_annex_7: {
              gross_amount: Math.round(grossDividend * 100) / 100,
              tax_rate: "22%",
              tax_amount: cit,
              recipient: shareholder.name,
              recipient_code: shareholder.code ?? "",
              note: "Submit TSD Annex 7 to EMTA by the 10th of the following month.",
            },
