...
function setupCamtTool(options: {
  ...
  registerCamtImportTools(server, api, { enableLightyear: true, exposeGranularTools: true, exposeSetupTools: true, enableTaxTools: true, enableReferenceAdmin: true, enableAnnualReport: true });
