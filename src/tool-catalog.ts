...
const FEATURE_GROUPS: ReadonlyArray<readonly [ToolFeature, Set<string>]> = [
  ...
  ["workflow", new Set("accounting_inbox continue_accounting_workflow resolve_accounting_review_item prepare_accounting_review_action save_auto_booking_rule recommend_workflow get_execution_plan_page get_operation_result_page".split(" "))],
];
